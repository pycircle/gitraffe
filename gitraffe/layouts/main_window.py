...
#
# Created: Mon Aug 20 01:25:58 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(os.path.dirname(__file__)+"/icons/push.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(os.path.dirname(__file__)+"/icons/clone.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionClone_repository.setIcon(icon5)
        ...
        self.actionClone_repository_2.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(os.path.dirname(__file__)+"/icons/settings.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionClone_repository_3.setIcon(icon5)
